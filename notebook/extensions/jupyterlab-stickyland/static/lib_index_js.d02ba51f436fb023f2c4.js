    ...
    constructor(panel) {
        ...
        this.headerMousedownHandler = (e) => {
            ...
            const mouseMoveHandler = (e) => {
                ...
                const nodeBBox = this.node.getBoundingClientRect();
                console.log(this.containerSize, mouseEvent.pageY, yOffset, newTop);
                const maxNewY = this.containerSize.y + this.containerSize.height - nodeBBox.height;
                let newY = Math.max(this.containerSize.y + WINDOW_GAP, newTop);
                newY = Math.min(maxNewY, newY);
                this.node.style.top = `${newY}px`;
            };
            const mouseUpHandler = () => {
...
//# sourceMappingURL=lib_index_js.d02ba51f436fb023f2c4.js.map